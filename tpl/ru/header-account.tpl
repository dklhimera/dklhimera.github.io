...
<head>
  ...
  <link href="css2/input.css" rel="stylesheet" type="text/css"/>
  <link href="css2/jquery.bxslider.css" rel="stylesheet" type="text/css"/>
  <link href="css2/style.css" rel="stylesheet" type="text/css"/>
  <link href="css2/fontello.css" rel="stylesheet" type="text/css"/>
  <link href="css2/account.css" rel="stylesheet" type="text/css"/>
...
<div class="left-panel">
  ...
  <ul class="user-menu">
      ...
      <li class="balance_wallets "><a href="/promo"><i class="demo-icon icon-award"></i>Промо материалы</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <ul class='menu'>
                ...
                <li><a href="/rules" {if $tpl_module == 'rules'} class="active"{/if}>Условия</a></li>
                <li><a href="/faq" {if $tpl_module == 'faq'} class="active"{/if}>Faq</a></li>
                <li><a href="/news" {if $tpl_module == 'news'} class="active"{/if}> Новости</a></li>
