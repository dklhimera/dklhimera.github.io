<?php /* Smarty version Smarty-3.1.8, created on 2016-05-16 21:09:59
...
<?php echo $_smarty_tpl->getSubTemplate ('edit.admin.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('values'=>$_smarty_tpl->tpl_vars['cfg']->value,'fields'=>array('HTTPSMode'=>array('S',"Использовать http<b>s</b> <<меняется только через https://>>",0,array(0=>'только на защищ.страницах',1=>'всегда'),'readonly'=>!$_smarty_tpl->tpl_vars['via_https']->value),'MinPIN'=>array('I','Мин. длина PIN-кода <<0 - не использовать>>'),'MinSQA'=>array('I','Мин. длина вопроса/ответа <<0 - не использовать>>'),'BFC'=>array('I','Запрашивать код подтверждения после N<br>неудачных попыток входа подряд <<0 - не использовать>>'),'IP'=>array('S','Контроль смены IP-адреса',0,array(0=>'нет',1=>'x.0.0.0',2=>'x.x.0.0',3=>'x.x.x.0',4=>'x.x.x.x')),'ForceReConfig'=>array('C','Требовать проверки "Личных параметров" после регистрации'),'PassTime'=>array('I','Требовать смену пароля каждые N дней <<0 - не требовать>>'),'TimeOut'=>array('I','Автовыход через N минут <<0 - не использовать>>'),'_IPs'=>array('A',"IP-адреса, с которых разрешен вход в Панель управления<br><<одна строка - один адрес в формате x.x.x.x>><br>Ваш текущий IP: <b>".($_smarty_tpl->tpl_vars['curr_ip']->value)."</b>"))), 0);?>
