<?php /* Smarty version Smarty-3.1.8, created on 2017-04-12 22:12:24
...
<?php if ($_valid && !is_callable('content_573a091945fa05_74317537')) {function content_573a091945fa05_74317537($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/c/ca56304/public_html/smarty3/plugins/modifier.replace.php';
?>
...
</title><link rel="shortcut icon" href="images/favicon.png"><link href="css2/bootstrap.min.css" rel="stylesheet" /><link href="css2/input.css" rel="stylesheet" type="text/css"/><link href="css2/jquery.bxslider.css" rel="stylesheet" type="text/css"/><link href="css2/style.css" rel="stylesheet" type="text/css"/><link href="css2/fontello.css" rel="stylesheet" type="text/css"/><link href="css2/account.css" rel="stylesheet" type="text/css"/><script src="js/jquery.min.js"></script><script src="js/jquery.bxslider.min.js"></script><script src="js/scripts.js"></script><script src="https://code.highcharts.com/highcharts.js"></script><script src="https://code.highcharts.com/modules/exporting.js"></script><script>$(function(){data_percent =<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['perc_json']->value,'&quot;','');?>
;data_percent1 =<?php echo smarty_modifier_replace($_smarty_tpl->tpl_vars['perc_calendar']->value,'&quot;','');?>
;});</script><script src="js/theme.js" type="text/javascript"></script><script src="js/sand-signika-ru.js"></script><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css"><link href='https://fonts.googleapis.com/css?family=PT+Sans&subset=latin,cyrillic' rel='stylesheet' type='text/css'><link href='https://fonts.googleapis.com/css?family=PT+Sans+Narrow:400,700&subset=latin,cyrillic' rel='stylesheet' type='text/css'></head><body><div class="left-panel"><div class="logo-account"><a href=""></a></div><ul class="user-menu"><li class="cabinet"><a href="cabinet"><i class="demo-icon icon-user-1"></i>Кабинет</a></li><li class="balance "><a href="operations"><i class="demo-icon icon-clock-2"></i>Операции</a></li><li class="depo "><a href="deposits"><i class="demo-icon icon-clipboard"></i>Депозиты</a></li><li class="refsys "><a href="refsys"><i class="demo-icon icon-group"></i>Реф. система</a></li><li class="balance_wallets "><a href="balance/wallets"><i class="demo-icon icon-credit-card"></i>Pеквизиты</a></li><li class="balance_wallets "><a href="/promo"><i class="demo-icon icon-award"></i>Промо материалы</a></li><li class="account "><a href="account"><i class="demo-icon icon-cogs"></i> Настройки </a></li></ul></div><div class="wrapper wrapper-cabinet"><section class="header"><div class="header-top"><div class="container-fluid"><div class="row"><div class="col-md-12"><div class="user-panel"><i></i><span><?php echo $_smarty_tpl->tpl_vars['user']->value['aName'];?>
</span><small><?php echo $_smarty_tpl->tpl_vars['user']->value['uMail'];?>
</small></div><ul class='menu'><li><a href="/home" <?php if ($_smarty_tpl->tpl_vars['tpl_module']->value=='index'){?> class="active"<?php }?>>Главная</a></li><li><a href="/rules" <?php if ($_smarty_tpl->tpl_vars['tpl_module']->value=='rules'){?> class="active"<?php }?>>Условия</a></li><li><a href="/faq" <?php if ($_smarty_tpl->tpl_vars['tpl_module']->value=='faq'){?> class="active"<?php }?>>Faq</a></li><li><a href="/news" <?php if ($_smarty_tpl->tpl_vars['tpl_module']->value=='news'){?> class="active"<?php }?>> Новости</a></li><li class='noborder'><a href="/support" <?php if ($_smarty_tpl->tpl_vars['tpl_module']->value=='message/support'){?> class="active"<?php }?>>Контакты</a></li><li class="other other-1"><a href="/login?out"><i class="demo-icon icon-lock"></i> Выход</a></li></ul></div></div></div></div><div class="header-preview"><div class="container-fluid"><div class="row"><div class="col-md-5"><?php echo $_smarty_tpl->getSubTemplate ('balance/bal-oper.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
