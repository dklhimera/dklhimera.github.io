<?php /* Smarty version Smarty-3.1.8, created on 2017-04-12 22:40:45
         compiled from "tpl/ru/edit.row.other.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1144768330573a0ae2be1815-55021163%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '495131d5aaf2edb89d5b3213efb74186aa8ec6a2' => 
    array (
      0 => 'tpl/ru/edit.row.other.tpl',
      1 => 1491722096,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1144768330573a0ae2be1815-55021163',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_573a0ae2f21d76_56232947',
  'variables' => 
  array (
    'v' => 0,
    'f' => 0,
...
<?php if ($_valid && !is_callable('content_573a0ae2f21d76_56232947')) {function content_573a0ae2f21d76_56232947($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['v']->value[0]=='U'){?>				<td colspan="2" align="center"><?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['v']->value[1], $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"></td><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='RR'){?><td colspan='2'  class='spec-td' align="center"><?php echo $_smarty_tpl->tpl_vars['error_text']->value;?>
...
</td><?php }else{ ?><td  align="right" width="<?php if ($_smarty_tpl->tpl_vars['l_width']->value){?><?php echo $_smarty_tpl->tpl_vars['l_width']->value;?>
<?php }else{ ?>0%<?php }?>"><?php if ($_smarty_tpl->tpl_vars['v']->value[1]){?><?php echo $_smarty_tpl->tpl_vars['l']->value;?>
<br><?php }?></td><td align="left"><?php echo $_smarty_tpl->tpl_vars['error_text']->value;?>
...
');</script><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='W'){?><p><textarea<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
<?php echo $_smarty_tpl->tpl_vars['hint']->value;?>
...
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
</textarea></p><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='XX'){?><span class="value<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
...
<?php }?></span><?php }else{ ?><p><input<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
<?php echo $_smarty_tpl->tpl_vars['hint']->value;?>
value="<?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
<?php }else{ ?>60<?php }?>" type="text" class="string<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"></p><?php }?></td><?php }?><br><?php }else{ ?><td align="right" width="<?php if ($_smarty_tpl->tpl_vars['l_width']->value){?><?php echo $_smarty_tpl->tpl_vars['l_width']->value;?>
<?php }else{ ?>0%<?php }?>"><?php echo $_smarty_tpl->tpl_vars['l']->value;?>
</td><td align="left"<?php if ($_smarty_tpl->tpl_vars['r_width']->value){?> width="<?php echo $_smarty_tpl->tpl_vars['r_width']->value;?>
"<?php }?>><p><?php echo $_smarty_tpl->tpl_vars['error_text']->value;?>
...
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='CCC'){?><input<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
value="<?php echo $_smarty_tpl->tpl_vars['v']->value[3];?>
"<?php if ($_smarty_tpl->tpl_vars['cv']->value==$_smarty_tpl->tpl_vars['v']->value[3]){?> checked="checked"<?php }?> type="checkbox" class="checkbox_small<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
...
"<?php if ($_smarty_tpl->tpl_vars['cv']->value==$_smarty_tpl->tpl_vars['v']->value[3]){?> checked="checked"<?php }?> type="radio" class="radio<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='S'){?><label class="select-css" style='width:100%;'><select<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
...
</option><?php }?><?php } ?></select></label><?php }elseif($_smarty_tpl->tpl_vars['v']->value[0]=='I'){?><input<?php echo $_smarty_tpl->tpl_vars['n']->value;?>
value="<?php echo $_smarty_tpl->tpl_vars['cv']->value;?>
" size="<?php if ($_smarty_tpl->tpl_vars['v']->value['size']>0){?><?php echo $_smarty_tpl->tpl_vars['v']->value['size'];?>
...
<?php }else{ ?>20<?php }?>"type="text" class="string_small<?php echo $_smarty_tpl->tpl_vars['class']->value;?>
<?php echo $_smarty_tpl->tpl_vars['error_class']->value;?>
"><?php }?></p><?php }?><?php if ($_smarty_tpl->tpl_vars['v']->value['readonly']){?><?php echo $_smarty_tpl->tpl_vars['hf']->value;?>
